...
public final class QueryUtils {
    ...
    public static List<com.example.android.booklistapp.Book> fetchEarthquakeData(String requestUrl) {
        ...
        List<com.example.android.booklistapp.Book> books = extractFeatureFromJson(jsonResponse);
     ...
     */
    private static List<com.example.android.booklistapp.Book> extractFeatureFromJson(String bookJSON) {
        ...
        List<com.example.android.booklistapp.Book> books = new ArrayList<>();
